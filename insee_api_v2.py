...
class INSEEAPIClient:
    ...
    def __init__(self):
        ...
        # URLs correctes pour l'API INSEE
    ...
    def get_access_token(self) -> str:
        ...
        try:
            print(f"🔑 Tentative d'authentification avec l'URL: {self.token_url}")
            ...
            print(f"📊 Réponse complète: {response.text if 'response' in locals() else 'Pas de réponse'}")
            raise
...
# Test du module avec debug
if __name__ == "__main__":
    try:
        print("🔧 Initialisation du client INSEE...")
